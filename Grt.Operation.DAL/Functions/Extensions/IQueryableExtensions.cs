...
namespace CMP.Operation.DAL.Functions.Extensions
{
    public static class IQueryableExtensions
    {
        ...
        /// <returns></returns>
        public static IEnumerable<Options> GetAvailableOrder(this IQueryable<OrderView> orderquery, int CountRecords = 10)
        {
